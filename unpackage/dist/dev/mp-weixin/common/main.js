...
var _index = _interopRequireDefault(__webpack_require__(/*! ./store/index */ 13));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var UniLoading = function UniLoading() {__webpack_require__.e(/*! require.ensure | components/loading/UniLoading */ "components/loading/UniLoading").then((function () {return resolve(__webpack_require__(/*! ./components/loading/UniLoading */ 82));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var UniAudioController = function UniAudioController() {__webpack_require__.e(/*! require.ensure | components/audio/UniAudioController */ "components/audio/UniAudioController").then((function () {return resolve(__webpack_require__(/*! ./components/audio/UniAudioController */ 89));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var UniMockPlayPage = function UniMockPlayPage() {__webpack_require__.e(/*! require.ensure | components/mockPlayPage/UniMockPlayPage */ "components/mockPlayPage/UniMockPlayPage").then((function () {return resolve(__webpack_require__(/*! ./components/mockPlayPage/UniMockPlayPage */ 96));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var PrepareImg = function PrepareImg() {__webpack_require__.e(/*! require.ensure | components/prepareImg/PrepareImg */ "components/prepareImg/PrepareImg").then((function () {return resolve(__webpack_require__(/*! ./components/prepareImg/PrepareImg */ 103));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var UniAlt = function UniAlt() {__webpack_require__.e(/*! require.ensure | components/alt/UniAlt */ "components/alt/UniAlt").then((function () {return resolve(__webpack_require__(/*! ./components/alt/UniAlt */ 110));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var UniCustomCheckbox = function UniCustomCheckbox() {__webpack_require__.e(/*! require.ensure | components/checkbox/UniCustomCheckbox */ "components/checkbox/UniCustomCheckbox").then((function () {return resolve(__webpack_require__(/*! ./components/checkbox/UniCustomCheckbox */ 117));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
...
_vue.default.component('uni-loading', UniLoading);
_vue.default.component('uni-audio-controller', UniAudioController);
_vue.default.component('uni-mock-play-page', UniMockPlayPage);
_vue.default.component('prepare-img', PrepareImg);
_vue.default.component('uni-alt', UniAlt);
_vue.default.component('uni-custom-checkbox', UniCustomCheckbox);
...

{
  onLaunch: function onLaunch() {var _this = this;
    ...
    this[_mutationsTypes.default.SET_AUDIO](uni.createInnerAudioContext());
    ...
    this[_mutationsTypes.default.SET_INITIALIZE]();
    ...
    this.getAudio.onTimeUpdate(function () {
      _this[_mutationsTypes.default.SET_CURRENT_TIME](_this.getAudio.currentTime);
    });

    this.getAudio.onPlay(function () {
      // console.log(`play: `);
      _this[_mutationsTypes.default.SET_SWITCH](true);
    });

    this.getAudio.onPause(function () {
      // console.log(`pause: `);
      _this[_mutationsTypes.default.SET_SWITCH](false);
    });

    this.getAudio.onStop(function () {
      console.log("stop: ");
    });
    ...
    this.getAudio.onError(function () {
      uni.showToast({
        title: '歌曲链接失效，请换一首！',
        icon: 'loading' });
  ...
  _mutationsTypes.default.SET_INITIALIZE,
