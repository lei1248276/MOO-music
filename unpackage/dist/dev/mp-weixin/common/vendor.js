...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"MOO","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!****************************************!*\
  !*** D:/Projects/hello-uni/pages.json ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 9 */
/*!******************************************************!*\
  !*** D:/Projects/hello-uni/store/mutations-types.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 13 */
/*!********************************************!*\
  !*** D:/Projects/hello-uni/store/index.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _mutations = _interopRequireDefault(__webpack_require__(/*! ./mutations */ 14));
var _actions = _interopRequireDefault(__webpack_require__(/*! ./actions */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* 14 */
/*!************************************************!*\
  !*** D:/Projects/hello-uni/store/mutations.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
_mutationsTypes.default.SET_IS_INIT, function (state) {
  state.isInit = true;
}), _defineProperty(_types$SET_INITIALIZE,


_mutationsTypes.default.SET_AUDIO, function (state, payload) {
  state.audio = payload;
}), _defineProperty(_types$SET_INITIALIZE,
...
_mutationsTypes.default.SET_PLAYLISTS, function (state, payload) {
  state.playlists = payload;
}), _defineProperty(_types$SET_INITIALIZE,


_mutationsTypes.default.SET_NEW_SONGLIST, function (state, payload) {
  state.newSonglist = payload;
}), _defineProperty(_types$SET_INITIALIZE,


_mutationsTypes.default.SET_SONGLIST_DETAILS, function (state, payload) {
...
_mutationsTypes.default.SET_CURRENT_PLAY_QUEUE, function (state, payload) {
...
_mutationsTypes.default.SET_CACHE_QUEUE, function (state, payload) {
  state.cacheQueue.set(payload.id, payload);
}), _defineProperty(_types$SET_INITIALIZE,


_mutationsTypes.default.SET_RECENT_PLAY_SONGS, function (state, payload) {
  var RPS = state.recentPlaySongs,i;
  // 查询最近播放列表中是否存在该歌曲，存在就从新放置到第一项，不存在就添加到第一项
  i = RPS.findIndex(function (value) {return value.id === payload.id;});
  if (i !== -1) {
    RPS.unshift.apply(RPS, _toConsumableArray(RPS.splice(i, 1)));
  } else {
    RPS.unshift(payload);
...
_mutationsTypes.default.SET_COL_SONGS, function (_ref, payload) {var colSongs = _ref.colSongs;
...
_mutationsTypes.default.SET_COL_PLAYLISTS, function (_ref2, payload) {var colPlaylists = _ref2.colPlaylists;
  if (Array.isArray(payload)) {
    payload.forEach(function (id) {
...
}), _types$SET_INITIALIZE);exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))

/***/ }),
/* 15 */
/*!**********************************************!*\
  !*** D:/Projects/hello-uni/store/actions.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _index = __webpack_require__(/*! @/network/index */ 16);
var _mutationsTypes = _interopRequireDefault(__webpack_require__(/*! ./mutations-types */ 9));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _slicedToArray(arr, i) {return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest();}function _nonIterableRest() {throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(o);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function _iterableToArrayLimit(arr, i) {if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return;var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"] != null) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}function _arrayWithHoles(arr) {if (Array.isArray(arr)) return arr;}var _default =

{
  getPlaySong: function getPlaySong(_ref, payload) {var state = _ref.state,commit = _ref.commit;
    // 避免重复发送网络请求（填坑）
    state.lock = true;

    var cache = state.cacheQueue;
    if (!payload.songUrl || !cache.has(payload.id)) {
      // console.log(`没有cache`);

      (0, _index.getSongUrl)(payload.id).then(function (res) {
        state.lock = false;var _res = _slicedToArray(
        ...
        if (url) {
          ...
          payload.songUrl = url;
          // 歌曲临时缓存队列
          commit(_mutationsTypes.default.SET_CACHE_QUEUE, payload);
          // 设置当前播放歌曲
          commit(_mutationsTypes.default.SET_CURRENT_SONG, payload);
          // 设置最近播放歌曲列表
          payload.playlistId !== 'recent' && commit(_mutationsTypes.default.SET_RECENT_PLAY_SONGS, payload);
        } else {
          throw new Error();
        }
      }).catch(function (err) {
      ...
      // 同样异步执行保持一致
      setTimeout(function () {return state.lock = false;});
      ...
      // 设置当前播放歌曲
      commit(_mutationsTypes.default.SET_CURRENT_SONG, cache);
      // 设置最近播放歌曲列表
      payload.playlistId !== 'recent' && commit(_mutationsTypes.default.SET_RECENT_PLAY_SONGS, cache);
    }
...
/* 16 */
/*!**********************************************!*\
  !*** D:/Projects/hello-uni/network/index.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getBanner = getBanner;exports.getRecommend = getRecommend;exports.getPlaylist = getPlaylist;exports.getPlaylistAll = getPlaylistAll;exports.getAlbum = getAlbum;exports.getSongs = getSongs;exports.getSongUrl = getSongUrl;exports.BASE_URL = void 0;
...
function getRecommend() {
  return uni.request({
    url: "".concat(BASE_URL, "/personalized?limit=3") });
...
function getPlaylist(id) {
  return uni.request({
    url: "".concat(BASE_URL, "/playlist/detail?id=").concat(id) });

}

// 请求所有 playlist 数据
function getPlaylistAll(offset, limit) {
  return uni.request({
    url: "".concat(BASE_URL, "/top/playlist?limit=").concat(limit, "&order=all&offset=").concat(offset) });
...
function getAlbum() {
  return uni.request({
    url: "".concat(BASE_URL, "/album/list?limit=3") });
...
function getSongs(ids) {
  return uni.request({
    url: "".concat(BASE_URL, "/song/detail?ids=").concat(ids) });
...
function getSongUrl(id) {
  return uni.request({
    url: "".concat(BASE_URL, "/song/url?id=").concat(id),
    timeout: 3000 });
...
/* 31 */
/*!*******************************************!*\
  !*** D:/Projects/hello-uni/util/index.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
