 ...
 */
export function getSearch<T>(keywords: string, type = 1, offset = 0, limit = 30) {
  return request.get<any, T>(`/cloudsearch?keywords=${keywords}&offset=${offset}&limit=${limit}&type=${type}`)
}
